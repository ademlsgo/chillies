...
// Read API base from Vite env (test-friendly: also read process.env in Vitest)
const API_URL = (import.meta as any).env?.VITE_API_URL || (process as any)?.env?.VITE_API_URL || 'http://localhost:8989';
